...
//ottieni una lista di tutti i simboli delle varie crypto
...
foreach ($intervals as $int)
{
	...
	{
		echo "file ".$filename." esiste. Skip.<br>";
		continue;
	}

	$ts_ms = round(microtime(true)*1000); //GMT UNIX timestamp corrente
	$qty = 10;
	$ts_last = 1483243199000; //1-1-2017 espresso in millisecondi
	...
	while ($ts_last < $ts_ms && $qty > 0)
	{
		...
		if ($qty == 500) {$string = substr($string, 0, -1); $string .= ",\n";}
